	...
	<form action="/usuario" method="post">	
		<div class="form-row">
			<div class="form-group col-md-5">
			  <label>Nome:</label>
			  <input type="text" value="Ju" class="form-control" placeholder="Entre com o seu nome" name="nome">
			</div>
	
			<div class="form-group col-md-5">
			  <label>E-mail:</label>
			  <input type="email" value="ju@ju.com" class="form-control" placeholder="Entre com o seu e-mail" name="email">
			</div>
